...
7.2 <a href="#commit-переходим-в-курсор-и-жмём-на-клиент-гита">Отправляем коммит</a> , текст кликабельный, нажмите на него
...
18. **Приступите к практике по git**
   ...
   - (опционально)[git course](https://learngitbranching.js.org/?locale=ru_RU) - доп курс по гит, если предыдущих не хватило.
19. **Практика  Github**
