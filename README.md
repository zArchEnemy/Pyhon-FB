...
7.1 **Если у вас есть локальный репозиторий на компьютере с вашей домашней работой, скопируйте ваш локальный репозиторий, в новый репозиторий, за исключением двух папок, ИХ МЫ НЕ КОПИРУЕМ**
   - /Math/school_theory 
